...
const steps = [
  {
    ...
    mockup: "/mockups/map-screen.webp",
  ...
  },
  {
    ...
    mockup: "/mockups/find-a-run.webp",
  ...
  },
  {
    ...
    mockup: "/mockups/court-checkin.webp",
  ...
  },
  {
    ...
    mockup: "/mockups/plan-a-run.webp",
  ...
  },
  {
    ...
    mockup: "/mockups/player-profiles.webp",
    ...
    <>
      <div className="era-subpage bg-black text-white min-h-screen relative">
        ...
        <section className="flex flex-col items-center text-center px-6 pt-32 pb-8 gap-3">
          ...
          <Reveal delay={120}>
            <p className="text-zinc-600 text-sm inline-flex items-center gap-1">Scroll to see each step <ChevronRight className="w-3.5 h-3.5" /></p>
          </Reveal>
        </section>
            ...
            <div className="inline-flex gap-4 [scroll-snap-type:x_mandatory]">
              ...
              {[
                ...
                },
                {
                  ...
                  mockup: "/mockups/leaderboard.webp",
