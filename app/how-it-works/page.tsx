  ...
  return (
    <>
      <div className="bg-black text-white flex flex-col min-h-screen">
        ...
        <section className="w-full px-6 sm:px-10 lg:px-20 pb-32 pt-8">
          <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-16 lg:gap-20">
            ...
            <div className="lg:w-[45%] flex flex-col gap-10">
              <div className="flex flex-col gap-4">
                ...
                <p className="text-zinc-400 text-sm leading-relaxed max-w-sm">
                  RunCheck gets you on the court in under a minute — no phone calls, no guessing, no wasted trips.
                </p>
              </div>
                ...
                {[
                  {
                    n: "01",
                    title: "Find a court",
                    body: "See every nearby court on a live map. Orange pins mean there's a run happening right now.",
                  },
                  {
                    n: "02",
                    title: "See who's there",
                    body: "Check player count, run level, and how long the game's been going — before you leave.",
                  },
                  {
                    n: "03",
                    title: "Check in",
                    body: "GPS-verified check-in tells everyone you're there. No more empty gyms.",
                  },
                ].map((s) => (
                  <div key={s.n} className="flex gap-5 items-start">
                    <span className="text-[11px] font-bold text-orange-500 mt-0.5 w-6 shrink-0 tabular-nums">
                      {s.n}
                    </span>
            ...
            {/* Phone composition column */}
            <div className="lg:w-[55%] flex items-end justify-center">
              {/*
                Both phones share a bottom baseline — same "floor" as the
                card section phones. Primary is taller and in front; secondary
                sits just behind and to the right, slightly shorter and dimmed.
                Container is sized so the two phones sit close together with
                a natural overlap rather than flying apart to opposite corners.
              */}
              <div className="relative w-[340px] h-[520px] sm:w-[460px] sm:h-[600px] shrink-0">

                {/* Secondary phone — behind, bottom-right */}
                <div className="absolute right-0 bottom-0 z-10">
                  <img
                    src="/mockups/nearby-courts-map.png"
                    alt="RunCheck — Nearby courts map"
                    className="
                      h-[420px] sm:h-[490px] w-auto object-contain
                      opacity-75
                      [filter:drop-shadow(0_-4px_20px_rgba(249,115,22,0.08))_drop-shadow(0_16px_40px_rgba(0,0,0,0.85))]
                    "
                  />
                </div>

                {/* Primary phone — front, bottom-left, taller */}
                <div className="absolute left-0 bottom-0 z-20">
                  <img
                    src="/mockups/find-a-run.png"
                    alt="RunCheck — Find a Run"
                    className="
                      h-[480px] sm:h-[560px] w-auto object-contain
                      [filter:drop-shadow(0_-6px_28px_rgba(249,115,22,0.22))_drop-shadow(0_20px_48px_rgba(0,0,0,0.9))]
                    "
                  />
                </div>
